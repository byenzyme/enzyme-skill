...
echo "The agent should read that setup skill before compile/init/petri."
echo ""
echo "Then ask your agent: Set up Enzyme for this vault. Read the installed"
echo "enzyme-workspace-setup skill first, then review the generated configuration"
echo "before running init."
echo ""
echo "Terminal-only setup:"
echo "  enzyme compile -v                       # propose a readable setup"
echo "  \$EDITOR ~/.enzyme/configs/*.enzyme      # adjust what to read, and for what"
echo "  enzyme init"
